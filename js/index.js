...
// вложенные проверки переписать на тернар
 ...
 //loginInput === 'Админ' ? const passwordInput = prompt('Введите свой пароль');
 //passwordInput ? passwordInput === 'Я главный' ? console.log('Здравствуйте!') : 
  //console.log('Неверный пароль') : console.log('Я вас не знаю'); console.log('Отменено');
